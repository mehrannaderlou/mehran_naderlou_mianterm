...
$_config            = array
                    (
                        ...
                        'site_name'                => 'مهران ندرلو 980063618',
                        'max_file_size'            => -1,
                        'allow_hotlinking'         => 0,
                        'upon_hotlink'             => 1,
                        'compress_output'          => 0
...
$_labels            = array
                    (
                        'include_form'    => array('Include Form', 'فرم کوچک ادرس سایت در هر صفحه قرار داده شود'),
                        'remove_scripts'  => array('Remove Scripts', 'حذف اسکریپت نویسی سمت مشتری (به عنوان مثال JavaScript)'),
                        'accept_cookies'  => array('Accept Cookies', 'به کوکی ها اجازه ذخیره داده شدن داده شود'),
                        'show_images'     => array('Show Images', 'نمایش تصاویر در صفحات'),
                        'show_referer'    => array('Show Referer', 'نمایش وب سایت ارجاع دهنده واقعی'),
                        'rotate13'        => array('Rotate13', 'از رمزگذاری ROT13 در آدرس استفاده شود'),
                        'base64_encode'   => array('Base64', 'از کدگذاری base64 در آدرس استفاده شود'),
                        'strip_meta'      => array('Strip Meta', 'برچسب های اطلاعات متا از صفحات پاک شوند'),
                        'strip_title'     => array('Strip Title', 'چرخاندن عنوان صفحه'),
                        'session_cookies' => array('Session Cookies', 'کوکی ها فقط برای این دفعه ذخیره شوند')
                    );
...
$_version           = 'پروژه میان ترم درس نظریه ی زبان ها و ماشین ها و روش پژوهش و ارائه';
