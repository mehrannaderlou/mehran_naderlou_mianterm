...
<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
	<div class="main">
		...
		<div class="form-row">
			<button class="button-submit" type="submit" name="action" value="submit">ارسال</button>
			<button class="button-submit" type="reset" name="action" value="reset">تنظیم مجدد</button>
			<a class="button-submit" href="index.php">بازگشت</a>
		</div>
	</div>
</form>
</body>
